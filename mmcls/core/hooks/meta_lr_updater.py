    ...
    def _set_lr(self, runner, lr_groups):
        if isinstance(runner.optimizer, dict):
            for k, optim in runner.optimizer.items():
                # print(self.name, k, self.name is None or self.name == k)
                if self.name is None or self.name == k:
...
class FixedMetaLrUpdaterHook(MetaLrUpdaterHook):

    def __init__(self, **kwargs):
        super(FixedMetaLrUpdaterHook, self).__init__(**kwargs)
...
@HOOKS.register_module()
class StepMetaLrUpdaterHook(MetaLrUpdaterHook):
    ...
    def __init__(self, step, gamma=0.1, min_lr=None, **kwargs):
        ...
        self.gamma = gamma
        self.min_lr = min_lr
        super(StepMetaLrUpdaterHook, self).__init__(**kwargs)
...
@HOOKS.register_module()
class ExpMetaLrUpdaterHook(MetaLrUpdaterHook):

    def __init__(self, gamma, **kwargs):
        self.gamma = gamma
        super(ExpMetaLrUpdaterHook, self).__init__(**kwargs)
...
@HOOKS.register_module()
class PolyMetaLrUpdaterHook(MetaLrUpdaterHook):

    def __init__(self, power=1., min_lr=0., **kwargs):
        self.power = power
        self.min_lr = min_lr
        super(PolyMetaLrUpdaterHook, self).__init__(**kwargs)
...
@HOOKS.register_module()
class InvMetaLrUpdaterHook(MetaLrUpdaterHook):

    def __init__(self, gamma, power=1., **kwargs):
        self.gamma = gamma
        self.power = power
        super(InvMetaLrUpdaterHook, self).__init__(**kwargs)
...
@HOOKS.register_module()
class CosineAnnealingMetaLrUpdaterHook(MetaLrUpdaterHook):

    def __init__(self, min_lr=None, min_lr_ratio=None, **kwargs):
        assert (min_lr is None) ^ (min_lr_ratio is None)
        self.min_lr = min_lr
        self.min_lr_ratio = min_lr_ratio
        super(CosineAnnealingMetaLrUpdaterHook, self).__init__(**kwargs)
...
@HOOKS.register_module()
class FlatCosineAnnealingMetaLrUpdaterHook(MetaLrUpdaterHook):
    ...
    def __init__(self,
        ...
        self.min_lr = min_lr
        self.min_lr_ratio = min_lr_ratio
        super(FlatCosineAnnealingMetaLrUpdaterHook, self).__init__(**kwargs)
...
@HOOKS.register_module()
class CosineRestartMetaLrUpdaterHook(MetaLrUpdaterHook):
    ...
    def __init__(self,
        ...
        super(CosineRestartMetaLrUpdaterHook, self).__init__(**kwargs)
...
@HOOKS.register_module()
class CyclicMetaLrUpdaterHook(MetaLrUpdaterHook):
    """Cyclic LR Scheduler.
    ...
    def __init__(self,
        ...
        super(CyclicMetaLrUpdaterHook, self).__init__(by_epoch, **kwargs)

    def before_run(self, runner):
        super(CyclicMetaLrUpdaterHook, self).before_run(runner)
        # initiate lr_phases
...
@HOOKS.register_module()
class OneCycleMetaLrUpdaterHook(MetaLrUpdaterHook):
    ...
    def __init__(self,
        ...
        self.lr_phases = []  # init lr_phases
        super(OneCycleMetaLrUpdaterHook, self).__init__(**kwargs)
