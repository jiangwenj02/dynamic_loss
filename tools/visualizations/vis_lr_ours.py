...
def simulate_train(data_loader, cfg, by_epoch=True):
    ...
    model = SimpleModel()
    if 'classifier' in cfg.optimizer:
        optimizer = build_optimizer(model, cfg.optimizer.classifier)
    else:
    ...
    # register hooks
    if 'classifier' in cfg.lr_config:
        runner.register_training_hooks(
            lr_config=cfg.lr_config.classifier,
...
def main():
    ...
    by_epoch = True if 'EpochBased' in cfg.runner.type else False
